...
<CardGroup cols={2}>
  <Card
    ...
    href="/installation"
  >
    Install the library in your PHP project using Composer or manual download
  </Card>
  <Card
    title="Quickstart"
    icon="rocket"
...
All methods return JSON-formatted data for easy integration with your applications.
